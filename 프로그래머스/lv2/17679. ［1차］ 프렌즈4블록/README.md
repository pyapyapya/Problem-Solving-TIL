...
[문제 링크](https://programmers.co.kr/learn/courses/30/lessons/17679?language=python3) 


### 어려웠던 점
- pop하고 나서 블록들을 내리는 아이디어를 생각하는데 많은 시간을 사용했다.
- 그래도 남은 블럭들을 list에 저장한 후, 블록들과 없는 블록을 구분하는 아이디어를 떠올려 상당히 좋은 발상을 했다고 생각한다.
- 이후에, 블럭이 없지만 4개로 pop이 되는 문제를 발견하였다.
- 문제 파악을 잘못해, pop한 횟수를 세고 있었는데, pop한 블럭의 수를 세는 것이었다.
- 이를 해결해 주어 AC를 받았다. 꽤 간단한 문제였는데 아이디어부터 디버깅까지 많은 것을 배운 문제다.
